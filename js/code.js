...
function listado_data(contador_actual = 1, actualiza_tabla = false) {
    ...
    if (actualiza_tabla) {
        ...
        for (let x = 1; x < contador_futuro; x++) {
            ...
            <td>
            <button class="fas fa-edit fs-5 me-3 blanco fondo_negro" onclick="editar_elemento(${x})"></button>
            <button class="fas fas fa-trash-alt fs-4 blanco fondo_negro"  onclick="borrar_elemento(${x})"></button>
            </td>
            </tr>
            `
        }
...
function enviar_formulario() {
    ...
    var telefono = document.getElementById('telefono_user').value;
    var correo = document.getElementById('correo_user').value;
    var direccion = document.getElementById('dirección_user').value;
    ...
    localStorage.setItem("correo_", correo);
    localStorage.setItem("direccion_", direccion);
    localStorage.setItem("presupuesto_", presupuesto);
